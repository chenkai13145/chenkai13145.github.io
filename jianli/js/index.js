...
$("document").ready(function(){
    $('#fullpage').fullpage({
        ...
        // navigationTooltips:['棣栭〉','鍏充簬鎴�','蹇冭矾鍘嗙▼','涓撲笟鎶€鑳�','鎴戠殑浣滃搧','鑱旂郴鎴�'],
        css3:'ture',
        ...
        afterLoad:function(link,index){
            ...
            break;
            case 3:
                move('.sec3-li1').set('margin-left','40%').duration('.5s').end()
                ...
                break;
            case 4:
                move('.sec4-pic').set('top','164px').duration('.5s').end(function(){
    ...
    $("#head-tit").hover(function() {
        ...
        $("#head-c").text("个人简历").css("color","#73a9cb");
    }, function() {
        $("#head-e").text("kai").css("color","#333");
